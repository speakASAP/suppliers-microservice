...
| --- | --- | --- | --- | --- |
| Warehouse | 246c0174eaee39ebb970a202cd8a1b0ac914c4f8 | ./scripts/deploy.sh | Warehouse /api/health returned HTTP 200 healthy after deployment at 246c017 | Anonymous Warehouse /api/warehouses/topology returned HTTP 401 after deployment |
| Catalog | 5510066ed63571ef4239ac0821942eed87d38bf1 | ./scripts/deploy.sh | Catalog /health returned HTTP 200 healthy after deployment at 5510066 | Anonymous Catalog POST /api/products/availability/coverage returned HTTP 401 after deployment |
| Suppliers | 95e31af1259af79fe2b41ab7d22282c3eca37005 | ./scripts/deploy.sh | Suppliers /api/health returned HTTP 200 healthy after deployment at 95e31af | Anonymous Suppliers /api/imports returned HTTP 401 after deployment |
...
| Cleanup or archival evidence is recorded. | cleanupEvidence=deferred:stock-traceability-runbook-20260621 | passed-runtime |
