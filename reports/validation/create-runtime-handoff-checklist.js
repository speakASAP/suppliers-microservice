...
10. Generate completed deployment evidence with \`RUNTIME_READINESS_MANIFEST_FILE=/tmp/stock-traceability-runtime-readiness/stock-traceability-runtime-readiness-manifest.json DEPLOYMENT_EVIDENCE_OUTPUT=/tmp/stock-traceability-deployment-evidence.json WAREHOUSE_HEALTH_EVIDENCE=<summary> WAREHOUSE_PROTECTED_ENDPOINT_EVIDENCE=<401-or-403-summary> CATALOG_HEALTH_EVIDENCE=<summary> CATALOG_PROTECTED_ENDPOINT_EVIDENCE=<401-or-403-summary> SUPPLIERS_HEALTH_EVIDENCE=<summary> SUPPLIERS_PROTECTED_ENDPOINT_EVIDENCE=<401-or-403-summary> node reports/validation/create-deployment-evidence.js\`, then verify it with \`node reports/validation/verify-deployment-evidence.js /tmp/stock-traceability-deployment-evidence.json\`. The deployment evidence must bind the same readiness manifest as the approval artifact.
...
function assertSelfTestContent(markdown) {
  const required = [
    ...
    'deployment evidence JSON bound to RUNTIME_READINESS_MANIFEST_FILE',
    'RUNTIME_READINESS_MANIFEST_FILE=/tmp/stock-traceability-runtime-readiness/stock-traceability-runtime-readiness-manifest.json DEPLOYMENT_EVIDENCE_OUTPUT=/tmp/stock-traceability-deployment-evidence.json',
    'deployment evidence must bind the same readiness manifest as the approval artifact',
    'readiness-bundle approval request',
