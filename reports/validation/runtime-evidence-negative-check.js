...
const cases = [
  ...
  runReportTextCase("mismatched-command-source-fingerprint-qty-evidence", (report) => report.replace(
    "sourceFingerprint=trace:product-synthetic:warehouse-supplier:warehouse-dropship:7:SUP-SKU-TRACE",
    "sourceFingerprint=trace:product-synthetic:warehouse-supplier:warehouse-dropship:8:SUP-SKU-TRACE"
  )),
  runReportTextCase("mismatched-command-source-fingerprint-sku-evidence", (report) => report.replace(
    "sourceFingerprint=trace:product-synthetic:warehouse-supplier:warehouse-dropship:7:SUP-SKU-TRACE",
    "sourceFingerprint=trace:product-synthetic:warehouse-supplier:warehouse-dropship:7:SUP-SKU-OTHER"
  )),
