...
function render(rows, preflight) {
  ...
  return [
    ...
    '- Warehouse, Catalog, and FlipFlop expose positive reservable local, supplier replenishment, and dropship route legs;',
    '- Suppliers import job belongs to TRACE_SUPPLIER_ID, validates the Catalog product ID, preserves Warehouse authority, records owner-approved mutation, and reports positive applied updates;',
