...
const checks = [
  ...
  },
  {
    ...
    patterns: ['RUNTIME_APPROVAL_ARTIFACT_OUTPUT', 'RUNTIME_APPROVAL_REQUEST_FILE', 'RUNTIME_READINESS_MANIFEST_FILE', 'readinessManifestBound', 'OWNER_APPROVAL=explicit is required to generate runtime approval artifact', 'RUNTIME_APPROVED_BY is required', 'runtime approval artifact requires approved trace inputs', 'TRACE_PRODUCT_ID', 'TRACE_IMPORT_IDEMPOTENCY_KEY', 'TRACE_CLEANUP_EVIDENCE', 'runtime approval artifact requires clean Warehouse, Catalog, and Suppliers worktrees', 'approval request file does not contain current', 'verify-runtime-approval-artifact.js', 'forbiddenActionsAcknowledged', 'dirtyRowsRejected', 'missingApprovalRejected', 'missingTraceInputRejected'],
  },
];
