...
const checks = [
  ...
  },
  {
    ...
    patterns: ['supplier_replenishment', 'supplier_dropship', 'getInventoryTopology', 'getBatchProductLogistics', 'canReserveFromWarehouse: route.canReserveFromWarehouse && warehouse.totalAvailable > 0', 'const preferredOption = options.find((option) => option.canReserveFromWarehouse)', 'preferredRoute: preferredOption?.routeType ?? null'],
  },
  {
    service: 'warehouse',
  ...
  },
  {
    ...
    patterns: ['TRACE_RUN_SUPPLIERS_IMPORT', 'TRACE_CLEANUP_EVIDENCE', 'TRACE_PRODUCT_SKU_PREFIX', 'CODEX-STOCK-TRACE-', 'TRACE_DROPSHIP_WAREHOUSE_ID', 'fixtureCheck', 'readHealth', "service, endpoint", 'catalogRouteTypes', 'projectionRouteTypes', 'summarizeLogisticsLegs', 'hasRequiredLogisticsLegs', 'hasRequiredReservableRoutes', 'sumTraceableReservableAvailability', 'projectionSellableRouteAvailable', 'canReserveFromWarehouse', 'sourceFingerprint', 'stockAuthority', 'warehouseTotalAvailable', 'assertConfiguredSupplierOwnership', 'assertConfiguredRouteSupplierOwnership', 'assertConfiguredRoute', 'Catalog forwarded own', 'FlipFlop forwarded own', 'warehouses/logistics/batch', 'availability/coverage/audit', 'catalogAvailability', 'TRACE_SUPPLIER_STOCK_QTY must be a positive integer', 'isCompletedEvidenceText', 'TRACE_CLEANUP_EVIDENCE must be completed and must not contain TODO or placeholder'],
    exactPatternCounts: {
      "'OWNER_APPROVAL=explicit'": 1,
    },
  },
  {
    service: 'suppliers',
    file: 'reports/validation/generate-runtime-evidence-report.js',
    patterns: ['VAL-CROSS-STOCK-RUNTIME-LIVE', 'Runtime complete', 'summarizeCatalogAvailability', 'summarizeStockAuthority', 'stockAuthorityComplete', 'projectionSellableRouteAvailable', 'isCompletedEvidenceText(smoke.cleanupEvidence)', 'summarizeFixtureCheck', 'fixtureCheckComplete', 'FIXTURE_CHECK_RESULT_FILE', 'hasAllRequiredRouteTypes', 'hasRequiredRouteLegs', 'hasRequiredReservableRoutes', 'available=', 'reservable=', 'summarizeRouteLegs', 'deploymentEvidenceComplete', 'generatedFromCurrentHeads', 'isCommitSha', 'namedHealthComplete', 'expectedSkuPrefix', '401|403', "source === 'warehouse'"],
    exactPatternCounts: {
  ...
  },
  {
    ...
    patterns: ['DEPLOYMENT_EVIDENCE_FILE', 'generated from current service heads', 'canonical UTC ISO timestamp', 'nonCanonicalDeploymentGeneratedAtRejected', 'completion verifier reminder', 'readinessManifest binding is required', 'readinessManifest.sha256', 'protectedEndpointEvidence must include 401 or 403', 'TODO or placeholder', 'worktree must be clean before deployment evidence can authorize runtime proof', 'staleDeploymentHeadRejected', 'missingProtectedEndpointRejected', 'placeholderEvidenceRejected', 'dirtyDeploymentRootRejected'],
  },
  {
    service: 'suppliers',
    file: 'reports/validation/run-runtime-evidence-flow.js',
    patterns: ['--fixture-check', 'RUN_APPROVED_RUNTIME_SMOKE=true', 'fixture-ready', 'RUNTIME_APPROVAL_ARTIFACT_FILE, and deployment evidence to continue', 'validateApprovedSmokeConfig', 'validateDeploymentEvidenceFile', 'canonical UTC generatedAt', 'canonical UTC ISO timestamp', 'generatedFromCurrentHeads', 'completion verifier reminder', 'assertCleanWorktreeForService', 'worktree must be clean before approved runtime evidence', 'currentHeadForService', 'commitSha must match current', 'OWNER_APPROVAL=explicit', 'SMOKE_ALLOW_MUTATION=true', 'TRACE_OWN_WAREHOUSE_ID', 'TRACE_SUPPLIER_STOCK_QTY', 'TRACE_SUPPLIER_SKU', 'sourceFingerprintEvidence', 'FIXTURE_CHECK_RESULT_FILE', 'generate-runtime-evidence-report.js', 'verify-runtime-evidence-report.js', 'verify-runtime-evidence-manifest.js', 'verify-runtime-evidence-bundle.js', 'verify-stock-traceability-completion.js', 'RUNTIME_EVIDENCE_MANIFEST', 'stock-traceability-runtime-evidence-manifest.json', 'sha256', 'dirtyWorktreeRejected', 'manifest self-test must reject dirty service worktrees before writing runtime evidence', '--manifest-self-test'],
    exactPatternCounts: {
  ...
  },
  {
    ...
    patterns: ['STOCK-TRACEABILITY-RUNTIME-HANDOFF', 'RUNTIME_HANDOFF_OUTPUT', 'completionGate', 'assertCleanRows', 'runtime handoff requires clean Warehouse, Catalog, and Suppliers worktrees', 'dirtyRowsRejected', 'handoff self-test must reject dirty source snapshots', 'formatCompletionReason', 'TRACE_SUPPLIER_STOCK_QTY', 'TRACE_SUPPLIER_SKU', 'TRACE_SUPPLIER_WAREHOUSE_ID linked to TRACE_SUPPLIER_ID', 'RUNTIME_APPROVAL_ARTIFACT_FILE', 'deployment evidence JSON bound to RUNTIME_READINESS_MANIFEST_FILE', 'RUNTIME_READINESS_MANIFEST_FILE=/tmp/stock-traceability-runtime-readiness/stock-traceability-runtime-readiness-manifest.json DEPLOYMENT_EVIDENCE_OUTPUT=/tmp/stock-traceability-deployment-evidence.json', 'deployment evidence must bind the same readiness manifest as the approval artifact', 'readiness-bundle approval request', 'verify-runtime-approval-artifact.js /tmp/stock-traceability-runtime-approval.json', 'fixture command and approved smoke command use the same TRACE_PRODUCT_ID', 'same TRACE_SUPPLIER_ID owns the supplier replenishment and dropship warehouse origins and route options', 'route warehouse IDs and the Suppliers source fingerprint match the redacted command trace IDs', 'positive availability and \\`canReserveFromWarehouse=true\\`', 'command/report trace-ID consistency', 'Suppliers import job completed, validated the Catalog product ID, preserved Warehouse stock authority', 'Deploy Warehouse first', 'RUN_APPROVED_RUNTIME_SMOKE=true', 'verify-runtime-evidence-manifest.js <manifest-file>', 'verify-runtime-evidence-bundle.js <manifest-file> <report-file>', 'verify-stock-traceability-completion.js <report-file> <manifest-file>', 'run-runtime-evidence-flow.js'],
  },
  {
    service: 'suppliers',
  ...
  },
  {
    ...
    patterns: ['RUNTIME_READINESS_MANIFEST', 'stock-traceability-runtime-readiness-manifest.json', 'ready-for-owner-approval', 'incomplete-runtime-pending', 'sha256 mismatch', 'byte count mismatch', 'readiness manifest serviceHeads', 'assertNoCredentialValues', 'credentialLeakRejected', 'approval request artifact must require', 'approvedTraceInputs', 'readiness plan artifact must require approved-smoke env vars', 'TRACE_IMPORT_IDEMPOTENCY_KEY', 'TRACE_CLEANUP_EVIDENCE', 'RUNTIME_APPROVAL_ARTIFACT_FILE', 'DEPLOYMENT_EVIDENCE_FILE', 'canonical UTC ISO timestamp', 'nonCanonicalReadinessGeneratedAtRejected', 'tamperedHashRejected', 'dirtyWorktreeRejected', 'staleHeadRejected'],
  },
  {
    service: 'suppliers',
  ...
  },
  {
    ...
    patterns: ['approved-smoke-missing-deployment-evidence', 'approved-smoke-missing-own-warehouse-id', 'approved-smoke-missing-owner-approval', 'approved-smoke-missing-mutation-allowance', 'approved-smoke-invalid-deployment-evidence', 'approved-smoke-non-canonical-deployment-generated-at', 'approved-smoke-deployment-sha-not-current-head', 'approved-smoke-missing-current-head-deployment-marker', 'approved-smoke-dirty-service-worktree', 'approved-smoke-missing-protected-endpoint-evidence', 'approved-smoke-health-evidence-still-placeholder', 'approved-smoke-template-not-complete-evidence', 'approved-smoke-trace-inputs-differ-from-approval', 'low-level-smoke-rejects-zero-supplier-stock-qty', 'low-level-smoke-rejects-placeholder-cleanup-evidence', 'approved-smoke-cleanup-evidence-differs-from-approval', 'approved runtime smoke trace inputs must match', 'RUN_APPROVED_RUNTIME_SMOKE', 'DEPLOYMENT_EVIDENCE_FILE', 'generatedFromCurrentHeads', 'verify-stock-traceability-completion.js', 'verify-runtime-evidence-manifest.js', 'verify-runtime-evidence-bundle.js', 'manifest-bundle-self-test-rejects-non-canonical-deployment-generated-at', 'mixedTraceProductRejected', 'mixedSupplierWarehouseRejected', 'mismatchedSupplierRejected', 'missingCatalogOwnRouteRejected', 'nonReservableSupplierRouteRejected', 'mismatchedSupplierJobFingerprintRejected', 'missingSupplierJobCatalogValidationRejected', 'mismatchedStockAuthorityRejected', 'mismatchedProjectionSellableRejected', 'cleanupPlaceholderRejected', 'missingProjectionOwnRouteRejected', 'runtime-report-verifier-self-test-rejects-placeholder-assertions', 'deployment-evidence-verifier-self-test-rejects-non-canonical-generated-at', 'runtime-readiness-verifier-self-test-rejects-non-canonical-generated-at', 'manifest-verifier-self-test-rejects-non-canonical-generated-at', '--manifest-self-test'],
    exactPatternCounts: {
  ...
  },
  {
    ...
    patterns: ['bad-sku-prefix', 'unnamed-health', 'missing-forwarded-supplier-route', 'missing-logistics-leg-evidence', 'missing-reservable-route-evidence', 'missing-origin-supplier-id-report-evidence', 'mismatched-route-supplier-report-evidence', 'mismatched-command-warehouse-report-evidence', 'mismatched-command-source-fingerprint-report-evidence', 'mismatched-command-source-fingerprint-qty-evidence', 'mismatched-command-source-fingerprint-sku-evidence', 'mismatched-fixture-command-product-evidence', 'mismatched-fixture-command-warehouse-evidence', 'missing-fixture-check-evidence', 'mismatched-supplier-job-source-fingerprint', 'mismatched-stock-authority-total', 'cleanup-evidence-placeholder', 'invalid-deployment-commit-sha', 'missing-deployment-service-row', 'missing-protected-endpoint-auth-evidence', 'deployment-health-evidence-placeholder', 'missing-current-head-deployment-marker', 'invalid-smoke-command-import-disabled', 'missing-smoke-command-own-warehouse-id', 'missing-runtime-approval-artifact-command-evidence', 'failed-runtime'],
  },
  {
    service: 'suppliers',
  ...
  },
  {
    ...
    patterns: ['supplier IDs match `TRACE_SUPPLIER_ID`', 'supplier routes are owned by `TRACE_SUPPLIER_ID`', 'route warehouse IDs matching the redacted smoke command trace IDs', 'read-only fixture command and approved smoke command must use the same trace product', 'supplier stock quantity, and supplier SKU', 'stamps stock candidates with the import supplier ID', 'rejects supplier identity drift before Warehouse mutation', 'Runtime Suppliers import job must belong to `TRACE_SUPPLIER_ID`', 'checked Catalog product IDs including `TRACE_PRODUCT_ID`', 'source fingerprint matching the approved trace import request', 'Warehouse authority', 'positive applied update count', 'FlipFlop stock quantity matches traceable reservable Warehouse route availability', 'clean current service heads', 'no dirty Warehouse/Catalog/Suppliers worktree state'],
  },
  {
    service: 'suppliers',
  ...
  },
  {
    ...
    patterns: ['STOCK-TRACEABILITY-RUNTIME-APPROVAL', 'RUNTIME_APPROVAL_ARTIFACT_FILE', 'approvalRequest binding is required', 'approvalRequest.sha256', 'approvalRequest must match readiness manifest approvalRequest artifact', 'mismatchedReadinessApprovalRequestRejected', 'readinessManifest binding is required', 'readinessManifest.sha256', 'verify-runtime-readiness-bundle.js', 'approval artifact readiness manifest must pass', 'approvedForCurrentCleanHeads', 'approvedBy must identify', 'placeholderApproverRejected', 'canonical UTC ISO timestamp', 'nonCanonicalApprovedAtRejected', 'approvedTraceInputs', 'TRACE_SUPPLIER_STOCK_QTY', 'TRACE_SUPPLIER_SKU', 'TRACE_CLEANUP_EVIDENCE', 'TODO or placeholder', 'placeholderCleanupEvidenceRejected', 'syntheticRecordsOnly', 'oneGuardedSyntheticImport', 'forbiddenActionsAcknowledged', 'token disclosure', 'worktree must be clean before runtime approval can authorize mutation', 'mismatchedApprovalHeadRejected', 'dirtyApprovalRootRejected', 'missingApprovalRequestRejected', 'tamperedApprovalRequestRejected', 'missingTraceInputRejected'],
  },
  {
    service: 'suppliers',
    file: 'reports/validation/create-runtime-approval-artifact.js',
    patterns: ['RUNTIME_APPROVAL_ARTIFACT_OUTPUT', 'RUNTIME_APPROVAL_REQUEST_FILE', 'RUNTIME_READINESS_MANIFEST_FILE', 'approvalRequestBinding', 'approval request file must match readiness manifest approvalRequest artifact', 'readinessManifestBound', 'OWNER_APPROVAL=explicit is required to generate runtime approval artifact', 'RUNTIME_APPROVED_BY is required', 'RUNTIME_APPROVED_BY must identify the approver', 'placeholderApproverRejected', 'RUNTIME_APPROVED_AT must be a canonical UTC ISO timestamp', 'nonCanonicalApprovedAtRejected', 'runtime approval artifact requires approved trace inputs', 'TRACE_PRODUCT_ID', 'TRACE_IMPORT_IDEMPOTENCY_KEY', 'TRACE_CLEANUP_EVIDENCE', 'TODO or placeholder', 'placeholderCleanupEvidenceRejected', 'runtime approval artifact requires clean Warehouse, Catalog, and Suppliers worktrees', 'approval request file does not contain current', 'verify-runtime-approval-artifact.js', 'forbiddenActionsAcknowledged', 'dirtyRowsRejected', 'missingApprovalRejected', 'missingTraceInputRejected'],
  },
];
