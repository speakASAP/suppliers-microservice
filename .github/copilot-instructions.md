# Copilot Instructions — `suppliers-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/suppliers-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/suppliers-microservice.git`, branch `main`.
